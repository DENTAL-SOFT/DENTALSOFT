...
var HeroService = (function () {
    function HeroService(http) {
        this.http = http;
        this.heroesPromise = Promise.resolve(mock_heroes_1.HEROES);
    ...
    HeroService.prototype.getHero = function (id) {
        return this.heroesPromise.then(function (heroes) { return heroes.filter(function (h) { return h.id === +id; })[0]; });
    };
